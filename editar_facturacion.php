<?php
	...
	---------------------------*/
include 'is_logged.php'; // Removed parentheses
...
/* Connect To Database*/
require_once "../config/db.php"; // Removed parentheses
require_once "../config/conexion.php"; // Removed parentheses
// Archivo de funciones PHP
include "../funciones.php"; // Removed parentheses
