<?php
	...
	/* Connect To Database */
	require_once "config/db.php"; // Sin paréntesis
	require_once "config/conexion.php"; // Sin paréntesis
...
<html lang="en">
  <head>
    <?php include "head.php"; ?> <!-- Sin paréntesis -->
  </head>
  <body>
	<?php include "navbar.php"; ?> <!-- Sin paréntesis -->
    ...
    <div class="container">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<?php
					include "modal/registro_productos.php"; // Sin paréntesis
					include "modal/editar_productos.php"; // Sin paréntesis
				?>
	...
	<hr>
	<?php include "footer.php"; ?> <!-- Sin paréntesis -->
